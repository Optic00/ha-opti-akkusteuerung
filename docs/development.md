...
`2026.9-beta3`, `2026.9-beta4`, `2026.9-beta5`, `2026.9-beta6`, `2026.9-beta7`, danach `2026.9.0` stabil und `2026.9.1` für
...
zum Beispiel mit `git tag -a 2026.9-beta7 -m "Opti Akku 2026.9-beta7"`. Vor dem Push
prüft `python tools/build_package.py --tag 2026.9-beta7 --check-release-ref`, dass
